          ...
          <form onChange={showSubmitButton ? undefined : () => form.handleSubmit(handleSubmit)()} onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            <div className="space-y-6">
              <div className="flex flex-wrap gap-4">
                {!hideClientsField && <FormField control={form.control} name="clientsNumber" render={({
                field
                ...
                {!hideTradesField && <FormField control={form.control} name="tradesPerClient" render={({
                field
              }) => <FormItem className="flex-1 min-w-[200px]">
              ...
              <div className="flex flex-wrap gap-4">
                <FormField control={form.control} name="burnWonChallenges" render={({
                field
              }) => <FormItem className="flex-1 min-w-[200px]">
                ...
                <FormField control={form.control} name="tradeOutputRandom" render={({
                field
              }) => <FormItem className="flex-1 min-w-[200px]">
              ...
              <Collapsible open={isBalanceDistributionOpen} onOpenChange={setIsBalanceDistributionOpen}>
                <div className="space-y-4">
                  ...
                  <CollapsibleContent className="space-y-4">
                    ...
                    {balanceFields.length > 0 && <div className="border rounded-lg">
                        <Table>
                          <TableHeader>
                            <TableRow>
                              <TableHead>Initial Balance ($)</TableHead>
                              <TableHead>Percentage (%)</TableHead>
                              <TableHead className="w-[80px]">Challenge Risk Parameters</TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            {balanceFields.map((field, index) => <TableRow key={field.id}>
                                <TableCell>
                                  <FormField control={form.control} name={`balanceDistribution.${index}.balance`} render={({
                              field
                            }) => <FormItem>
                                        <FormControl>
                                ...
                                <TableCell>
                                  <FormField control={form.control} name={`balanceDistribution.${index}.percentage`} render={({
                              field
                            }) => <FormItem>
                                        <FormControl>
                                ...
                                <TableCell>
                                  <Button type="button" onClick={() => removeBalance(index)} variant="outline" size="sm">
                    ...
                    {balanceFields.length === 0 && <div className="text-center py-8 text-muted-foreground">
              ...
              <Collapsible open={isLevelsOpen} onOpenChange={setIsLevelsOpen}>
                <div className="space-y-4">
                  ...
                  <CollapsibleContent className="space-y-4">
                    ...
                    {levelFields.length > 0 && <div className="border rounded-lg">
                        <Table>
                          <TableHeader>
                            <TableRow>
                          ...
                          <TableBody>
                            {levelFields.map((field, index) => <TableRow key={field.id}>
                                <TableCell>
                                  <FormField control={form.control} name={`levels.${index}.maxBalance`} render={({
                              field
                            }) => <FormItem>
                                        <FormControl>
                                ...
                                <TableCell>
                                  <FormField control={form.control} name={`levels.${index}.sl`} render={({
                              field
                            }) => <FormItem>
                                        <FormControl>
                                          <Input type="number" step="0.01" {...field} className="w-full" />
                                ...
                                <TableCell>
                                  <FormField control={form.control} name={`levels.${index}.tp`} render={({
                              field
                            }) => <FormItem>
                                        <FormControl>
                                          <Input type="number" step="0.01" {...field} className="w-full" placeholder="Empty = auto (gap to max balance)" />
                                        </FormControl>
                                        <FormMessage />
                                      </FormItem>} />
                                </TableCell>
                    ...
                    {levelFields.length === 0 && <div className="text-center py-8 text-muted-foreground">
            ...
            {showSubmitButton && <Button type="submit" className="w-full bg-black hover:bg-gray-800 text-white" disabled={isLoading}>
                {isLoading ? <>
